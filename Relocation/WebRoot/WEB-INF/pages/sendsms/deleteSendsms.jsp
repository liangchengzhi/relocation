...
<html>
<head>
<title>View <fmt:message key="sendsms.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			<h1><fmt:message key="sendsms.title"/> Details</h1>
			...
			<table cellpadding="0" cellspacing="0" id="viewTable">
				<tbody>
					...
					<tr>
						...
						<td>
							<fmt:formatDate dateStyle="short" type="both" value="${sendsms.createdtime.time}"/>
						&nbsp;
						</td>
					</tr>
					<tr>
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteSendsms?idKey=${sendsms.id}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
