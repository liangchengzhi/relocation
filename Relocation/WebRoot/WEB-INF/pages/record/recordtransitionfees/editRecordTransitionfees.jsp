...
<html>
<head>
<title>Edit <fmt:message key="record.title"/> <fmt:message key="recordtransitionfee.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveRecordRecordTransitionfees" method="POST" modelAttribute="recordtransitionfee">
