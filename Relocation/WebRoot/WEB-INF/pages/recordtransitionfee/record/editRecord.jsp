...
<html>
<head>
<title>Edit <fmt:message key="recordtransitionfee.title"/> <fmt:message key="record.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveRecordTransitionfeeRecord" method="POST" modelAttribute="record">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="recordtransitionfee_id" value="${recordtransitionfee_id}" >
