...
<html>
<head>
<title>Edit <fmt:message key="recordtransitionfee.title"/> <fmt:message key="cuser.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveRecordTransitionfeeCuser" method="POST" modelAttribute="cuser">
