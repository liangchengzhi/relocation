...
<html>
<head>
<title>Edit <fmt:message key="recordtransitionfee.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveRecordTransitionfee" method="POST" modelAttribute="recordtransitionfee">
