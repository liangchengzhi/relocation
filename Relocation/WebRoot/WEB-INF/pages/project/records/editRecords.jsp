...
<html>
<head>
<title>Edit <fmt:message key="project.title"/> <fmt:message key="record.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveProjectRecords" method="POST" modelAttribute="record">
