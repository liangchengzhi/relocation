		...
		<table id="listTable" cellpadding="0" cellspacing="0">
			<thead>
				<tr>
					...
					<th class="thead"><fmt:message key="project.isdeleted.title"/></th>
				</tr>
			</thead>
			<tbody>
				...
				<tr class="${rowclass}">
					<td nowrap="nowrap" class="tabletd">
						...
						<a title="<fmt:message key="navigation.edit" />" href="${pageContext.request.contextPath}/editProject?idKey=${current.id}&"><img src="images/icons/edit.gif" /></a>
