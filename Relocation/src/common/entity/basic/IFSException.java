 ...
 * </pre>
 */
public class IFSException extends RuntimeException {
	...
	public IFSException(String message,String errorCode) {
		super(message);
		this.setErrorCode(errorCode);
	}

	public IFSException(Throwable cause) {
		super(cause);
	}

	public IFSException(Throwable cause,String message, String errorCode) {
		super(message, cause);
		this.setErrorCode(errorCode);
	}
