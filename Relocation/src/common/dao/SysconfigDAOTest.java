...
public class SysconfigDAOTest {
	 ...
	 *
	 */
	private SysconfigDAO dataStore;

	/**
	 * Instantiates a new SysconfigDAOTest.
	 *
	 */
	public SysconfigDAOTest() {
	}

	/**
	 * Method to test Sysconfig domain object.
	 *
	 */
	@Rollback(false)
	@Test
	public void Sysconfig() {
		Sysconfig instance = new Sysconfig();
	 ...
	 */
	@Autowired
	public void setDataStore(SysconfigDAO dataStore) {
